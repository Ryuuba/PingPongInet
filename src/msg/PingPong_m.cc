...
EXECUTE_ON_STARTUP(
    omnetpp::cEnum *e = omnetpp::cEnum::find("inet::PingPongMessageType");
    if (!e) omnetpp::enums.getInstance()->add(e = new omnetpp::cEnum("inet::PingPongMessageType"));
    e->insert(PING, "PING");
    e->insert(PONG, "PONG");
)
...
PingPongPacket::PingPongPacket() : ::inet::FieldsChunk()
{
}

PingPongPacket::PingPongPacket(const PingPongPacket& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}
...
inet::PingPongMessageType PingPongPacket::getType() const
{
    return this->type;
}

void PingPongPacket::setType(inet::PingPongMessageType type)
{
    handleChange();
    this->type = type;
}

int PingPongPacket::getIdentifier() const
{
    return this->identifier;
}

void PingPongPacket::setIdentifier(int identifier)
{
    handleChange();
    this->identifier = identifier;
}

int PingPongPacket::getSeqNumber() const
{
    return this->seqNumber;
}

void PingPongPacket::setSeqNumber(int seqNumber)
{
    handleChange();
...
PingPongPacketDescriptor::PingPongPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::PingPongPacket)), "inet::FieldsChunk")
{
...
const char *PingPongPacketDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "inet::PingPongMessageType",    // FIELD_type
...
const char *PingPongPacketDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    ...
    switch (field) {
        case FIELD_type:
            if (!strcmp(propertyname, "enum")) return "inet::PingPongMessageType";
            return nullptr;
        default: return nullptr;
    }
}
...
std::string PingPongPacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    PingPongPacket *pp = (PingPongPacket *)object; (void)pp;
    switch (field) {
        case FIELD_type: return enum2string(pp->getType(), "inet::PingPongMessageType");
...
bool PingPongPacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
